...
public class GradingSettingsPartValidatorUnitTests(TestDefinitionValidatorFixture fixture)
{
    ...
    public async Task GradingSettingsPart_TestEndConfig_Validate_Failure_Miss_ToAddress()
    {
        ...
        Assert.Equal(1,
            result.Errors.Count(c =>
                c.PropertyName.EndsWith(nameof(TestEndConfig.ToAddress)) && c.ErrorCode == "NotEmptyValidator"));
    }
    ...
    public async Task GradingSettingsPart_TestEndConfig_Validate_Failure_NoNeed_ToAddress()
    {
        ...
        Assert.Equal(1,
            result.Errors.Count(c =>
                c.PropertyName.EndsWith(nameof(TestEndConfig.ToAddress)) && c.ErrorCode == "NullValidator"));
    }
    ...
    public async Task GradingSettingsPart_PassMaskCriteria_Validate_Failure_InvalidPercentValue(int value)
    {
        ...
        Assert.Equal(1,
            result.Errors.Count(c =>
                c.PropertyName == nameof(PassMaskCriteria.Value) && c.ErrorCode == "InclusiveBetweenValidator"));
    }
    ...
    public async Task GradingSettingsPart_PassMaskCriteria_Validate_Failure_InvalidPointValue(int value)
    {
        ...
        Assert.Equal(1,
            result.Errors.Count(c =>
                c.PropertyName == nameof(PassMaskCriteria.Value) && c.ErrorCode == "GreaterThanValidator"));
    }
    ...
    public async Task GradingSettingsPart_InformRespondentConfig_Validate_Failure(GradingSettingsPart input)
    {
        var context = new ValidationContext<InformRespondentConfig>(input.InformRespondentConfig)
        {
            RootContextData =
            {
                ["GradingSettingsPart.GradingCriterias"] = input.GradingCriterias,
            },
        };
    ...
    private async Task<TestValidationResult<GradeRangeCriteria>> DoGradeRangeCriteriaValidate(
        GradeRangeCriteria input)
    {
        ...
        var ctx = new ValidationContext<GradeRangeCriteria>(input)
        {
            RootContextData =
            {
                ["TestId"] = TestDefinitionValidatorFixture.TestMock.Id,
            },
        };
    ...
    private static GradingSettingsPart CreateFullValidSampleOfGradingSettingsPart()
    {
    ...
    public static IEnumerable<object[]> GetTestData_InformRespondentConfig_Failure()
    {
        ...
        // Descriptive factor, but no suitable GradeRanges/GradeType.
