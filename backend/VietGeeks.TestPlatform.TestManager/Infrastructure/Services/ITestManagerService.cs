...
namespace VietGeeks.TestPlatform.TestManager.Infrastructure.Services
{
    ...
    {
        Task<PagedSearchResult<TestDefinitionOverview>> GetTestDefinitionOverviews(int pageNumber, int pageSize,
        ...
        Task<TestDefinitionViewModel> ActivateTestDefinition(string id, CancellationToken cancellationToken);
        Task<TestDefinitionViewModel> UpdateTestDefinition(string id, UpdateTestDefinitionViewModel viewModel);
        Task<TestDefinitionViewModel> EndTestDefinition(string id, CancellationToken cancellationToken);
