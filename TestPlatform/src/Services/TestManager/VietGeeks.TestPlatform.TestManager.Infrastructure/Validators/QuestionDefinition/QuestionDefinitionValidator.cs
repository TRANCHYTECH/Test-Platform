...
using Models = VietGeeks.TestPlatform.TestManager.Core.Models;


namespace VietGeeks.TestPlatform.TestManager.Infrastructure.Validators.QuestionDefinition
{
    public class QuestionDefinitionValidator : AbstractValidator<Models.QuestionDefinition>
    {
        public QuestionDefinitionValidator(
            IQuestionRelatedValidationService validationService,
            IValidator<Models.Answer> validator1,
        ...
        private static Action<ScoreSettings, ValidationContext<Models.QuestionDefinition>> AnswerTypeMatchValidator()
        {
            return (prop, ctx) =>
            {
        ...
        private static bool CheckAnswerTypeMatch(Models.QuestionDefinition setttings)
        {
    ...
    public class AnswerValidator : AbstractValidator<Models.Answer>
    {
